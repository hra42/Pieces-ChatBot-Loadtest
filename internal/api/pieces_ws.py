...
import queue
import os
import internal.environment.read_env


# Read environment variables
IP = os.environ.get("PIECES_INSTANCE_HOST", "localhost")
PORT = os.environ.get("PIECES_INSTANCE_PORT", "1000")
WEBSOCKET_URL = f"ws://{IP}:{PORT}/qgpt/stream"
TIMEOUT = 10  # seconds
